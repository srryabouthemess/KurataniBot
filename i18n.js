 ...
 *
 * Idiomas suportados: 'pt' (Português BR), 'en' (English)
...
const translations = {
  pt: {
    ...
    topplays_footer:         (label) => `Página 1/1 • Modo: osu! • ${label}`,
    ...
    recent_footer:           (mode, date, label) => `Modo: ${mode} | ${date} • ${label}`,
  ...
  en: {
    ...
    topplays_footer:         (label) => `Page 1/1 • Mode: osu! • ${label}`,
    ...
    recent_footer:           (mode, date, label) => `Mode: ${mode} | ${date} • ${label}`,
...
const SUPPORTED_LANGS = { pt: 'Português', en: 'English' };
