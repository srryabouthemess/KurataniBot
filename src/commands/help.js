...
const GROUPS = [
  { key: 'stats',  commands: ['profile', 'recent', 'topplays', 'nochoke', 'score', 'compare', 'leaderboard', 'topscores'] },
 ...
 */
const ADMIN_GROUP = { key: 'admin', commands: ['nominate', 'moderate', 'role', 'wipe', 'scorewipe', 'staff'] };
